...
lives in `figrecipe._utils._close`; this module re-exports the public
API for backward compatibility with existing
`from scitex.plt.utils._close import …` callers.
"""
from figrecipe._utils._close import *  # noqa: F401, F403
