"""Auto-generated smoke test for scitex.custom.export_as_csv_utils.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.custom.export_as_csv_utils')
    except ImportError as e:
        pytest.skip(f"scitex.custom.export_as_csv_utils: {e}")
