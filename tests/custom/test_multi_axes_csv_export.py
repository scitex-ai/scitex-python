"""Auto-generated smoke test for scitex.custom.multi_axes_csv_export.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.custom.multi_axes_csv_export')
    except ImportError as e:
        pytest.skip(f"scitex.custom.multi_axes_csv_export: {e}")
