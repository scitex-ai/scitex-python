"""Auto-generated smoke test for scitex.custom.pip_install_latest.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.custom.pip_install_latest')
    except ImportError as e:
        pytest.skip(f"scitex.custom.pip_install_latest: {e}")
