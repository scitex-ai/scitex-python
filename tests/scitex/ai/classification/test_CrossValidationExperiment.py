"""Auto-generated smoke test for scitex.ai.classification.CrossValidationExperiment.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.classification.CrossValidationExperiment')
    except ImportError as e:
        pytest.skip(f"scitex.ai.classification.CrossValidationExperiment: {e}")
