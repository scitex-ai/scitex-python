"""Auto-generated smoke test for scitex.ai.classification.timeseries._TimeSeriesMetadata.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.classification.timeseries._TimeSeriesMetadata')
    except ImportError as e:
        pytest.skip(f"scitex.ai.classification.timeseries._TimeSeriesMetadata: {e}")
