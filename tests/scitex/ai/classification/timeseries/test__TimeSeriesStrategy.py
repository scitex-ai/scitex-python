"""Auto-generated smoke test for scitex.ai.classification.timeseries._TimeSeriesStrategy.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.classification.timeseries._TimeSeriesStrategy')
    except ImportError as e:
        pytest.skip(f"scitex.ai.classification.timeseries._TimeSeriesStrategy: {e}")
