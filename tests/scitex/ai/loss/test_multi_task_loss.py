"""Auto-generated smoke test for scitex.ai.loss.multi_task_loss.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.loss.multi_task_loss')
    except ImportError as e:
        pytest.skip(f"scitex.ai.loss.multi_task_loss: {e}")
