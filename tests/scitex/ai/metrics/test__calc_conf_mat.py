"""Auto-generated smoke test for scitex.ai.metrics._calc_conf_mat.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.metrics._calc_conf_mat')
    except ImportError as e:
        pytest.skip(f"scitex.ai.metrics._calc_conf_mat: {e}")
