"""Auto-generated smoke test for scitex.ai.metrics._calc_seizure_prediction_metrics.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.metrics._calc_seizure_prediction_metrics')
    except ImportError as e:
        pytest.skip(f"scitex.ai.metrics._calc_seizure_prediction_metrics: {e}")
