"""Auto-generated smoke test for scitex.ai.metrics._normalize_labels.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.metrics._normalize_labels')
    except ImportError as e:
        pytest.skip(f"scitex.ai.metrics._normalize_labels: {e}")
