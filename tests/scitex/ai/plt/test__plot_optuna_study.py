"""Auto-generated smoke test for scitex.ai.plt._plot_optuna_study.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.plt._plot_optuna_study')
    except ImportError as e:
        pytest.skip(f"scitex.ai.plt._plot_optuna_study: {e}")
