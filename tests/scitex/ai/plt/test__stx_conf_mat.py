"""Auto-generated smoke test for scitex.ai.plt._stx_conf_mat.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.plt._stx_conf_mat')
    except ImportError as e:
        pytest.skip(f"scitex.ai.plt._stx_conf_mat: {e}")
