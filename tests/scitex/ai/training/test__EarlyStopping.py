"""Auto-generated smoke test for scitex.ai.training._EarlyStopping.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ai.training._EarlyStopping')
    except ImportError as e:
        pytest.skip(f"scitex.ai.training._EarlyStopping: {e}")
