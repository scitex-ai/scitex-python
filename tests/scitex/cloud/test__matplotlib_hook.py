"""Auto-generated smoke test for scitex.cloud._matplotlib_hook.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.cloud._matplotlib_hook')
    except ImportError as e:
        pytest.skip(f"scitex.cloud._matplotlib_hook: {e}")
