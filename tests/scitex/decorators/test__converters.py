"""Auto-generated smoke test for scitex.decorators._converters.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.decorators._converters')
    except ImportError as e:
        pytest.skip(f"scitex.decorators._converters: {e}")
