"""Auto-generated smoke test for scitex.dev.plt.demo_plotters.plot_sns_heatmap.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.demo_plotters.plot_sns_heatmap')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.demo_plotters.plot_sns_heatmap: {e}")
