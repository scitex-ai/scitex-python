"""Auto-generated smoke test for scitex.dev.plt.demo_plotters.plot_sns_histplot.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.demo_plotters.plot_sns_histplot')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.demo_plotters.plot_sns_histplot: {e}")
