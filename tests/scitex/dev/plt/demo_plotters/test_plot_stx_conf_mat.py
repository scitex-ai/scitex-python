"""Auto-generated smoke test for scitex.dev.plt.demo_plotters.plot_stx_conf_mat.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.demo_plotters.plot_stx_conf_mat')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.demo_plotters.plot_stx_conf_mat: {e}")
