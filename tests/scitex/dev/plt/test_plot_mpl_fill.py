"""Auto-generated smoke test for scitex.dev.plt.plot_mpl_fill.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.plot_mpl_fill')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.plot_mpl_fill: {e}")
