"""Auto-generated smoke test for scitex.dev.plt.plot_mpl_pie.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.plot_mpl_pie')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.plot_mpl_pie: {e}")
