"""Auto-generated smoke test for scitex.dev.plt.plot_sns_scatterplot.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.plot_sns_scatterplot')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.plot_sns_scatterplot: {e}")
