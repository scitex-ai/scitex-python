"""Auto-generated smoke test for scitex.dev.plt.plot_sns_swarmplot.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.plot_sns_swarmplot')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.plot_sns_swarmplot: {e}")
