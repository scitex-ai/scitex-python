"""Auto-generated smoke test for scitex.dev.plt.plot_stx_barh.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.plot_stx_barh')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.plot_stx_barh: {e}")
