"""Auto-generated smoke test for scitex.dev.plt.plot_stx_rectangle.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.dev.plt.plot_stx_rectangle')
    except ImportError as e:
        pytest.skip(f"scitex.dev.plt.plot_stx_rectangle: {e}")
