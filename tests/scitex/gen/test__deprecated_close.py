"""Auto-generated smoke test for scitex.gen._deprecated_close.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.gen._deprecated_close')
    except ImportError as e:
        pytest.skip(f"scitex.gen._deprecated_close: {e}")
