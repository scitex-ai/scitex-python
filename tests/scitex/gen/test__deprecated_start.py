"""Auto-generated smoke test for scitex.gen._deprecated_start.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.gen._deprecated_start')
    except ImportError as e:
        pytest.skip(f"scitex.gen._deprecated_start: {e}")
