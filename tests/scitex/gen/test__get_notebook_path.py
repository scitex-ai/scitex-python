"""Auto-generated smoke test for scitex.gen._get_notebook_path.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.gen._get_notebook_path')
    except ImportError as e:
        pytest.skip(f"scitex.gen._get_notebook_path: {e}")
