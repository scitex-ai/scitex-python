"""Auto-generated smoke test for scitex.io.bundle._conversion._dict2bundle.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle._conversion._dict2bundle')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle._conversion._dict2bundle: {e}")
