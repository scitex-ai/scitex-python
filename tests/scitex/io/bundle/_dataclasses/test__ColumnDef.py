"""Auto-generated smoke test for scitex.io.bundle._dataclasses._ColumnDef.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle._dataclasses._ColumnDef')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle._dataclasses._ColumnDef: {e}")
