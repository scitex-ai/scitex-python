"""Auto-generated smoke test for scitex.io.bundle._extractors._extract_bar.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle._extractors._extract_bar')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle._extractors._extract_bar: {e}")
