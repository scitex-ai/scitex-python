"""Auto-generated smoke test for scitex.io.bundle._extractors._extract_scatter.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle._extractors._extract_scatter')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle._extractors._extract_scatter: {e}")
