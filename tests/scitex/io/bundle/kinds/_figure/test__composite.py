"""Auto-generated smoke test for scitex.io.bundle.kinds._figure._composite.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._figure._composite')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._figure._composite: {e}")
