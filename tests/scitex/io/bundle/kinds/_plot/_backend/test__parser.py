"""Auto-generated smoke test for scitex.io.bundle.kinds._plot._backend._parser.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._plot._backend._parser')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._plot._backend._parser: {e}")
