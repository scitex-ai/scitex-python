"""Auto-generated smoke test for scitex.io.bundle.kinds._plot._models._Axes.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._plot._models._Axes')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._plot._models._Axes: {e}")
