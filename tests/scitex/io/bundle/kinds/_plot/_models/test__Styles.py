"""Auto-generated smoke test for scitex.io.bundle.kinds._plot._models._Styles.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._plot._models._Styles')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._plot._models._Styles: {e}")
