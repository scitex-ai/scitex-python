"""Auto-generated smoke test for scitex.io.bundle.kinds._plot._utils._calc_bounds.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._plot._utils._calc_bounds')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._plot._utils._calc_bounds: {e}")
