"""Auto-generated smoke test for scitex.io.bundle.kinds._plot._utils._normalize.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._plot._utils._normalize')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._plot._utils._normalize: {e}")
