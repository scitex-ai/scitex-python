"""Auto-generated smoke test for scitex.io.bundle.kinds._plot._utils._validate.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._plot._utils._validate')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._plot._utils._validate: {e}")
