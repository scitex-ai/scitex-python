"""Auto-generated smoke test for scitex.io.bundle.kinds._stats._dataclasses._Stats.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._stats._dataclasses._Stats')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._stats._dataclasses._Stats: {e}")
