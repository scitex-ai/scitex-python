"""Auto-generated smoke test for scitex.io.bundle.kinds._table._latex._editor._app.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._table._latex._editor._app')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._table._latex._editor._app: {e}")
