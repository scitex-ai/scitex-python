"""Auto-generated smoke test for scitex.io.bundle.kinds._table._latex._validator.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle.kinds._table._latex._validator')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle.kinds._table._latex._validator: {e}")
