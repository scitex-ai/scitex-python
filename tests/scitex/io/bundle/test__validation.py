"""Auto-generated smoke test for scitex.io.bundle._validation.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.io.bundle._validation')
    except ImportError as e:
        pytest.skip(f"scitex.io.bundle._validation: {e}")
