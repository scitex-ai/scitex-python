"""Auto-generated smoke test for scitex.plt._mcp.plt__handlers_annotation.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt._mcp.plt__handlers_annotation')
    except ImportError as e:
        pytest.skip(f"scitex.plt._mcp.plt__handlers_annotation: {e}")
