"""Auto-generated smoke test for scitex.plt.color._get_colors_from_conf_matap.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.color._get_colors_from_conf_matap')
    except ImportError as e:
        pytest.skip(f"scitex.plt.color._get_colors_from_conf_matap: {e}")
