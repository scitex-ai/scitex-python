"""Auto-generated smoke test for scitex.plt.gallery._registry.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.gallery._registry')
    except ImportError as e:
        pytest.skip(f"scitex.plt.gallery._registry: {e}")
