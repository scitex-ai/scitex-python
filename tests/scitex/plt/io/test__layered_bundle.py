"""Auto-generated smoke test for scitex.plt.io._layered_bundle.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.io._layered_bundle')
    except ImportError as e:
        pytest.skip(f"scitex.plt.io._layered_bundle: {e}")
