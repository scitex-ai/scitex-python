"""Auto-generated smoke test for scitex.plt.styles._style_loader.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.styles._style_loader')
    except ImportError as e:
        pytest.skip(f"scitex.plt.styles._style_loader: {e}")
