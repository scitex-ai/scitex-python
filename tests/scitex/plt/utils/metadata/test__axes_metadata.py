"""Auto-generated smoke test for scitex.plt.utils.metadata._axes_metadata.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._axes_metadata')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._axes_metadata: {e}")
