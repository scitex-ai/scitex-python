"""Auto-generated smoke test for scitex.plt.utils.metadata._core.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._core')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._core: {e}")
