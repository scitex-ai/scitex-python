"""Auto-generated smoke test for scitex.plt.utils.metadata._data_linkage.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._data_linkage')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._data_linkage: {e}")
