"""Auto-generated smoke test for scitex.plt.utils.metadata._editable_export.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._editable_export')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._editable_export: {e}")
