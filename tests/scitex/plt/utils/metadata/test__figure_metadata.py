"""Auto-generated smoke test for scitex.plt.utils.metadata._figure_metadata.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._figure_metadata')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._figure_metadata: {e}")
