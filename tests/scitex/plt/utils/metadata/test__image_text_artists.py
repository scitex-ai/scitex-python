"""Auto-generated smoke test for scitex.plt.utils.metadata._image_text_artists.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._image_text_artists')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._image_text_artists: {e}")
