"""Auto-generated smoke test for scitex.plt.utils.metadata._label_parsing.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._label_parsing')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._label_parsing: {e}")
