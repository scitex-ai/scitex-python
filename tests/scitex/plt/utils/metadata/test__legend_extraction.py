"""Auto-generated smoke test for scitex.plt.utils.metadata._legend_extraction.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._legend_extraction')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._legend_extraction: {e}")
