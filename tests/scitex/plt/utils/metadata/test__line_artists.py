"""Auto-generated smoke test for scitex.plt.utils.metadata._line_artists.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._line_artists')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._line_artists: {e}")
