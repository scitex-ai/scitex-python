"""Auto-generated smoke test for scitex.plt.utils.metadata._patch_artists.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._patch_artists')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._patch_artists: {e}")
