"""Auto-generated smoke test for scitex.plt.utils.metadata._plot_type_detection.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._plot_type_detection')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._plot_type_detection: {e}")
