"""Auto-generated smoke test for scitex.plt.utils.metadata._precision_config.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils.metadata._precision_config')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils.metadata._precision_config: {e}")
