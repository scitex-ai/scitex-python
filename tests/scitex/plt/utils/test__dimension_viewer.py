"""Auto-generated smoke test for scitex.plt.utils._dimension_viewer.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils._dimension_viewer')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils._dimension_viewer: {e}")
