"""Auto-generated smoke test for scitex.plt.utils._figure_from_axes_mm.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils._figure_from_axes_mm')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils._figure_from_axes_mm: {e}")
