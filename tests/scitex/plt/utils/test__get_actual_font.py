"""Auto-generated smoke test for scitex.plt.utils._get_actual_font.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils._get_actual_font')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils._get_actual_font: {e}")
