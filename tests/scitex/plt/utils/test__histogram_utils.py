"""Auto-generated smoke test for scitex.plt.utils._histogram_utils.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.plt.utils._histogram_utils')
    except ImportError as e:
        pytest.skip(f"scitex.plt.utils._histogram_utils: {e}")
