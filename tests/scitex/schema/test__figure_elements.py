"""Auto-generated smoke test for scitex.schema._figure_elements.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.schema._figure_elements')
    except ImportError as e:
        pytest.skip(f"scitex.schema._figure_elements: {e}")
