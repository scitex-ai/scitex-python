"""Auto-generated smoke test for scitex.ui._backends._config.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ui._backends._config')
    except ImportError as e:
        pytest.skip(f"scitex.ui._backends._config: {e}")
