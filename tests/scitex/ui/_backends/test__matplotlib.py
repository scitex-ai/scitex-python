"""Auto-generated smoke test for scitex.ui._backends._matplotlib.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ui._backends._matplotlib')
    except ImportError as e:
        pytest.skip(f"scitex.ui._backends._matplotlib: {e}")
