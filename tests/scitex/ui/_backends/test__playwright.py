"""Auto-generated smoke test for scitex.ui._backends._playwright.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex.ui._backends._playwright')
    except ImportError as e:
        pytest.skip(f"scitex.ui._backends._playwright: {e}")
